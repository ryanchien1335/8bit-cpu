...
For clarity, some components are shown twice: once for control signal connections and once for data bus connections. These represent the same physical hardware.
...
+-----------------------------+           |
|       Microprogram ROM      |           |
|    (Control Signal Store)   |           |
+--------------+--------------+           |
               |                          |
               v                          |                           +------------------+
+-----------------------------+-----------+                           |     DATA BUS     |
|         CONTROL BUS         |                                       |   (8-bit Shared) |
+--------------+--------------+                                       +---------+--------+
               |                                                                |  
               +--> +------------------+   +-->  +------------------+           + <-> +------------------+   + <->  +------------------+          
               |    |    Register A    |         |       RAM        |           |     |    Register A    |          |       RAM        |              
               |    +------------------+         +------------------+           |     +------------------+          +------------------+                 
               |                                                                |                           
               +--> +------------------+   +--> +-----------------------+       + --> +------------------+   + <->  +-----------------------+     
               |    |    Register B    |        |   Keyboard Hardware   |       |     |    Register B    |          |   Keyboard Hardware   |                 
               |    +--------+---------+        +-----------------------+       |     +--------+---------+          +-----------------------+  
               |             |                                                  |              | 
               |             v                                                  |              v          
               +--> +------------------+   +--> +------------------+            + <-> +------------------+    +-->  +------------------+     +------------------+    
                    |       ALU        |        | Output Register  |                  |       ALU        |          | Output Register  +---> |    LED Output    |  
                    |   (OP Select)    |        +------------------+                  +------------------+          +------------------+     +------------------+
                    +------------------+                                                               
